...
<body <?php body_class();?>>
<div id="wrapper">
    <div class="header-top" style="height:95px;">
          ...
          <nav class="navbar navbar-expand-md p-0">
              <ul class="navbar-nav">
                <li class="nav-item site-title">
                  <a class="nav-link <?php if(isset($post->post_name) && $post->post_name == 'inicio'){ echo 'home-main-link'; } ?>" href="/"><i class="icon-home"></i> Inicio</a>
                </li>
              </ul>          
              ...
              <div id="main-nav" class="collapse navbar-collapse justify-content-end">
                <ul id="menu-principal" class="navbar-nav">
                    <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-inicio" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-inicio nav-item">
                        <a title="Inicio" href="/" class="nav-link <?php if(isset($post->post_name) && $post->post_name == 'inicio'){ echo 'active'; } ?>">Inicio</a>
                    </li>                    
                    <li itemscope="itemscope" itemtype="https://www.schema.org/SiteNavigationElement" id="menu-item-322" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-322 nav-item">
